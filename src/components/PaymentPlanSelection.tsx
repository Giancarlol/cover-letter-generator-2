...
const PaymentPlanSelection: React.FC<PaymentPlanProps> = ({ 
  ...
  const plans = [
    { 
      ...
      price: 0, 
      letters: 5, 
      features: ['5 letters per month: Limited access, suitable for occasional use.', 'Basic letter generation: Simple, basic letters with limited customization.'] 
    },
    { 
      name: 'Basic Plan', 
      ...
      letters: 20,
      duration: '1 week',
      features: ['20 letters per week: Ideal for moderate users needing regular letters', 'Highly personalized letters: Tailored for a more specific audience or purpose', 'Priority support: Faster support responses when needed.', 'Powered by Advanced AI model: Enhanced, high-quality letters generated by an advanced AI.'] 
    },
    { 
      name: 'Premium Plan', 
      ...
      letters: 40,
      duration: '2 weeks',
      features: ['40 letters every two weeks: Ample supply for high-volume users', 'Highly personalized letters: Enhanced customization for any need', '24/7 support: Immediate support at any time', 'Powered by Advanced AI model: Highest-quality letters with the latest AI enhancements'] 
    },
  ];
